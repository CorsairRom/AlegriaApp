...
from ApiArriendosAlegria.views import get_api_regions, get_api_comunas_by_id_reg, get_api_banks, get_api_TypeAccountsBanks, get_api_CrudTyperWorkers
...
urlpatterns = [
    ...
    path('tipo_trabajador/', get_api_CrudTyperWorkers, name='get_api_CrudTyperWorkers'),
